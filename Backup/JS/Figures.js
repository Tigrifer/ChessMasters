...
function Pow(_g, x, y, c) {
    ...
    this.game = _g;
    $(this.container).addClass('figure '+(this.color==Color.black?'b':'')+'Pawn').appendTo(this.game.GetDomElement(this.field.x, this.field.y));
    this.moveCount = 0;
    this.jumped = false;
